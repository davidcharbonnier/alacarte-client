...
class ApiConfig {
  ...
  static const String userMeDelete = '/api/user/me'; // DELETE for account deletion
  ...
  static String ratingBulkUnshare(int userId) => '/api/rating/bulk/unshare/$userId';
  
  // Community statistics endpoints (anonymous aggregate data)
  static String communityStats(String type, int id) => '/api/stats/community/$type/$id';
